...
class Settings(BaseSettings):
    ...
    MODELS_DIR: Path = BASE_DIR / "models" / "saved_models"

    # Model files - matching your saved models
    MODEL_FILES: dict = {
        "lightgbm": "lightgbm_regressor_20251205_194841.pkl",
        "random_forest": "random_forest_regressor_20251205_194841.pkl",
        "xgboost": "xgboost_regressor_20251205_194841.pkl",
        "linear_regression": "linear_regression_(ridge)_20251205_194841.pkl"
    }
